...
async function addCommunitiesToUser() {
  try {
    ...
    const userId2 = "8Wk64lm7pceeL4o3HC2VuN3F8nD3"; // Your user ID
    console.log(`Adding communities to user ID: ${userId2}`);

    // Define new community memberships
    const newMemberships1 = [
      {
        id: "membership7", // Unique ID for this membership
        userId2: userId2,
        communityId: "community1", // Springfield
        type: "resident",
        address: {
          street: "456 Pine St", // Example address, adjust as needed
          city: "Springfield",
          state: "IL",
          zipCode: "62703",
          verificationDocumentUrls: ["https://example.com/docs/ckurdoghlian_springfield_id.jpg"]
      ...
      {
        id: "membership8", // Unique ID for this membership
        userId2: userId2,
        communityId: "community2", // Shelbyville
        type: "resident",
        address: {
          street: "46 Elm St", // Example address, adjust as needed
          city: "Shelbyville",
          state: "IL",
          zipCode: "62565",
          verificationDocumentUrls: ["https://example.com/docs/ckurdoghlian_shelbyville_id.jpg"]
